...
ax.set_xlabel("time [s]")
ax.set_ylabel("strain [e-21]")
ax.set_title("Συγκρισή ανακατασκευασμένου σήματος με αριθμετική προσέγγιση βαρυτικού κύματος, Livingston.")
...
ax.set_title("Φασματογράφημα βαρυτικού κύματος, Livingston")
